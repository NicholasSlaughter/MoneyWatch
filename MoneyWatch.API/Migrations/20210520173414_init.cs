        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfExpense = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    AlertCreationDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    PeriodStartDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    PriodEndDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    PeriodId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PeriodId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Alert_Period_PeriodId1",
